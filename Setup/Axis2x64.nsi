...
!define MSVS_PATH "C:\Program Files\Microsoft Visual Studio 8\VC\redist\amd64"
...
;General
  ...
  ;Name and file
  Name "Axis2 - ${Version}"
  OutFile "Axis2x64_Setup_${Version}.exe"
  ...
  VIAddVersionKey /LANG=1033-English "ProductVersion" "${Version} x64"
  VIAddVersionKey /LANG=1033-English "ProductName" "Axis2 GM Tool"
  VIAddVersionKey /LANG=1033-English "FileVersion" "${Version} x64"
